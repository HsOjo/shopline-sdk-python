...
class MemberPoint(BaseModel):
    ...
    """Order Number"""
    type: Optional[Literal['manual', 'auto_reward', 'expired', 'order_redeemed', 'redeemed_to_cash', 'order_split_revert', 'product_review_reward', 'member_info_reward', 'return_order_revert', 'order_edit_revert']] = None
