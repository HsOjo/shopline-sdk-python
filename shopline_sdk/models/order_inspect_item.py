...
class OrderInspectItem(BaseModel):
    ...
    inspect_status: Optional[Literal['accepted', 'rejected', 'pending']] = None
    """Order inspect item status"""
    return_reason_key: Optional[Literal['not_expected', 'broke_during_delivery', 'wrong_variation', 'wrong_item', 'other', 'admin_return_order']] = None
    """return reason 退貨原因"""
