...
class PromotionsSetting(BaseModel):
    ...
    multi_order_discount_strategy: Optional[Union[
        Literal['order_or_tier_promotion', 'order_and_tier_promotions', 'multi_order_and_tier_promotions'], str]] = None
    ...
    category_item_gift_threshold_mode: Optional[
        Union[Literal['before_discounts', 'after_price_discounts', 'after_all_discounts'], str]] = None
    ...
    order_free_shipping_threshold_mode: Optional[
        Union[Literal['after_price_discounts', 'after_all_discounts'], str]] = None
    ...
    category_item_free_shipping_threshold_mode: Optional[
        Union[Literal['before_discounts', 'after_price_discounts', 'after_all_discounts'], str]] = None
