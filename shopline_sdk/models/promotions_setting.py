...
class PromotionsSetting(BaseModel):
    ...
    multi_order_discount_strategy: Optional[Literal['order_or_tier_promotion', 'order_and_tier_promotions', 'multi_order_and_tier_promotions']] = None
    ...
    order_gift_threshold_mode: Optional[Literal['after_price_discounts', 'after_all_discounts']] = None
    ...
    category_item_gift_threshold_mode: Optional[Literal['before_discounts', 'after_price_discounts', 'after_all_discounts']] = None
    ...
    order_free_shipping_threshold_mode: Optional[Literal['after_price_discounts', 'after_all_discounts']] = None
    ...
    category_item_free_shipping_threshold_mode: Optional[Literal['before_discounts', 'after_price_discounts', 'after_all_discounts']] = None
