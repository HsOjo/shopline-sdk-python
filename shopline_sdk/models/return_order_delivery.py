...
class ReturnOrderDelivery(BaseModel):
    ...
    delivery_status: Optional[Literal['arrived', 'collected', 'expired', 'failed', 'pending', 'request_accepted', 'request_authorized', 'request_submitted', 'returned', 'returning', 'returning_store_closed', 'shipped', 'store_closed']] = None
