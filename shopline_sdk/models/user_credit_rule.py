...
class UserCreditRule(BaseModel):
    ...
    rule_type: Optional[Literal['pos_apply_credit', 'auto_reward', 'apply_partial_credit', 'welcome_credit', 'birthday_credit', 'max_amount_per_order', 'max_percentage_per_order', 'apply_user_credit']] = None
    ...
    credit_value: Optional[int] = None
    """購物金"""
    credit_value_type: Optional[Literal['amount', 'percentage']] = None
    ...
    """自動累計"""
    accumulated_type: Optional[Literal['credit', 'percentage']] = None
